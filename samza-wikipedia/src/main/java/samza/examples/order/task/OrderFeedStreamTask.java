...
package samza.examples.order.task;
 ...
 * sends them to a Kafka topic called order-raw.
 */
public class OrderFeedStreamTask implements StreamTask {
    ...
    public void process(IncomingMessageEnvelope envelope,
        ...
        Map<String, Object> outgoingMap = OrderFeedRow
                .toMap((OrderFeedRow) envelope.getMessage());

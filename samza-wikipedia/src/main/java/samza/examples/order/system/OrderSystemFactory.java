...
public class OrderSystemFactory implements SystemFactory {
  @Override
  ...
  public SystemConsumer getConsumer(String systemName, Config config, MetricsRegistry registry) {
    ...
    OrderFeed feed = new OrderFeed(host, port, db, usr, psw);

    return new OrderConsumer(systemName, feed, registry);
  }

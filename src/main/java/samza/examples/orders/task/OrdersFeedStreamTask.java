...
package samza.examples.orders.task;
 ...
 */
public class OrdersFeedStreamTask implements StreamTask {
  private static final SystemStream OUTPUT_STREAM = new SystemStream("kafka", "orders-raw");
